...
export function AppSidebar() {
  ...
  const MenuGroup = ({
    ...
    items: typeof mainMenuItems;
      ...
      <SidebarGroupLabel className="text-xs font-semibold text-purple-600 uppercase tracking-wide my-[10px]">
        {label}
      </SidebarGroupLabel>
      <SidebarGroupContent>
        <SidebarMenu>
  ...
  return <Sidebar className="border-r border-blue-100 bg-gradient-to-b from-blue-50/50 to-purple-50/50">
      ...
      <SidebarFooter className="p-4 border-t border-blue-100">
        <Button onClick={handleSignOut} variant="outline" size="sm" className="w-full justify-start gap-2 border-red-200 text-red-700 hover:bg-red-50 hover:border-red-300">
