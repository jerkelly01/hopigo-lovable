...
import { LifestyleService } from '@/constants/lifestyle-services';
import { Receipt, Car, Ticket, Heart, Award, Percent } from 'lucide-react-native';
import Colors from '@/constants/colors';

interface LifestyleServiceCardProps {
...
export function LifestyleServiceCard({ service, onPress, style }: LifestyleServiceCardProps) {
